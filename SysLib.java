...
public class SysLib {
    ...
    // calls Kernel with the following parameters: 
    ...
    */
    ...
    // Implemented in final project:
    // Closes the file specified in fd 
    // calls Kernel with the following parameters:
    /* fd = file descriptor
    */
    ...
    // Implemented in final project:
    // reads the file speicifed in fd into buffer 
    // calls Kernel with the following parameters: 
    /* fd = file descriptor
       buffer = buffer amount to read
    */
    ...
    // Implemented in final project:
    // Writes to the file specified at fd
    // uses the contents of buffer to write into fd 
    // calls Kernel with the following parameters: 
    /* fd = file descriptor
       buffer = buffer to write into file
    */
    ...
    */
    ...
    // calls Kernel with the following parameters: 
    /* fd = file descriptor 
       offset = amount to move seek pointer
       whence = mode that seek moves 
       whence can be (0, 1, or 2 mode as defined by class & textbook) 
    */
    ...
    // Implemented in final project: calls Kernel with 
